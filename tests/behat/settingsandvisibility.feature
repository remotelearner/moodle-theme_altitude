Feature: Basic visibility and navigability tests.
    ...
    Scenario: Admin user can enable the theme, log out, and log in.
        ...
        And I log out
        And I special log in as "student"
    ...
    @theme @theme_altitude @javascript @altitude_slideout
    ...
    @theme @theme_altitude @javascript @_file_upload @altitude_banner
    Scenario: Admin user can turn of demo mode and add custom slider images and text.
        ...
        And "#slider .slide1 #banner-title" "css_element" should be visible
    ...
    @theme @theme_altitude @javascript @_file_upload @altitude_customcss
